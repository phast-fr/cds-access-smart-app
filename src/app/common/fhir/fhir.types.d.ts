export declare namespace fhir {
    ...
    /**
     * Indicates whether this flag is active and needs to be displayed to a user, or whether it is no longer needed or
     * entered in error
     */
    ...
    export interface DoseAndRate extends Element {
      /**
       * The kind of dose or rate specified DoseAndRateType
       */
      type?: CodeableConcept;
      /**
    ...
    export interface AdverseEvent extends DomainResource {
        ...
        /**
         * AE | PAE
         * An adverse event is an event that caused harm to a patient,  an adverse reaction is a something that is a
         * subject-specific event that is a result of an exposure to a medication, food, device or environmental
         * substance, a potential adverse event is something that occurred and that could have caused harm to a patient
         * but did not
         */
    ...
    export interface Goal extends DomainResource {
        ...
        identifier?: Identifier[];
        /**
         * proposed | accepted | planned | in-progress | on-target | ahead-of-target | behind-target | sustaining |
         * achieved | on-hold | cancelled | entered-in-error | rejected
         */
        status: GoalStatus;
        /**
         * Contains extended information for property 'status'.
    ...
    export interface MeasureReportGroupPopulation extends BackboneElement {
        ...
        /**
         * initial-population | numerator | numerator-exclusion | denominator | denominator-exclusion |
         * denominator-exception | measure-population | measure-population-exclusion | measure-score
         */
        code?: CodeableConcept;
        /**
    ...
    export interface Schedule extends DomainResource {
        ...
        specialty?: CodeableConcept[];
        /**
         * The resource this Schedule resource is providing availability information for. These are expected to usually
         * be one of HealthcareService, Location, Practitioner, PractitionerRole, Device, Patient or RelatedPerson
         */
        actor: Reference[];
        /**
         * The period of time that the slots that are attached to this Schedule resource cover (even if none exist).
         * These  cover the amount of time that an organization's planning horizon; the interval for which they are
         * currently accepting appointments. This does not define a "template" for planning outside these dates
         */
        planningHorizon?: Period;
        /**
         * Comments on the availability to describe any extended information. Such as custom constraints on the slots
    ...
    export interface Sequence extends DomainResource {
        ...
        _type?: Element;
        /**
         * Base number of coordinate system (0 for 0-based numbering or coordinates, inclusive start, exclusive end, 1
         * for 1-based numbering, inclusive start, inclusive end)
         */
    ...
    export interface Slot extends DomainResource {
         ...
         * which is at a location, rather than the location itself). If provided then this overrides the value provided
